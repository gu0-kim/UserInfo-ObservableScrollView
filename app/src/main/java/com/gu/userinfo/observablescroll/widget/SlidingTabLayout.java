...
package com.gu.userinfo.observablescroll.widget;
 ...
 * com.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer} interface which provides
...
public class SlidingTabLayout extends HorizontalScrollView {
  ...
  /**
   * Set the custom {@link com.google.samples.apps.iosched.ui.widget.SlidingTabLayout.TabColorizer}
   * to be used.
   *
   ...
   * com.google.samples.apps.iosched.ui.widget.SlidingTabLayout} you are required to set any {@link
   * ViewPager.OnPageChangeListener} through this method. This is so that the layout can update it's
