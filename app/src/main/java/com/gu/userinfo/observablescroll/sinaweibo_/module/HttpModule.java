...
public class HttpModule {
  ...
  public static HttpModule getInstance() {
    if (instance == null) instance = new HttpModule();
    return instance;
  }

  public Observable<List<String>> connectUrl(String url) {
    Log.e(TAG, "connectUrl: thread is " + Thread.currentThread());
    return Observable.zip(
        getPageData1(), Observable.timer(3, TimeUnit.SECONDS), (strings, aLong) -> strings);
  }
